...
namespace Khinen
{
    public partial class Form1 : Form
    {
        ...
        {
            pictureBox1.Visible = false;
            axAcroPDF1.src = Environment.CurrentDirectory + @"\KhiCuDien_3D\ContacTor.pdf";
        }
        ...
        private void button104_Click(object sender, EventArgs e)
        {
            ...
            countDevice += 1;
            node.Id = "" + countDevice;
            node.Image = Properties.Resources._2_ap_ke;
            node.Transparent = true;
            node.ImageAlign = MindFusion.Drawing.ImageAlign.Fit;


            device.PortCount = 2;
            device.port.Add(new PointF(0.611F * device.shapenode.Bounds.Width + device.shapenode.Bounds.X,
                1.00F * device.shapenode.Bounds.Height + device.shapenode.Bounds.Y));
            device.port.Add(new PointF(0.364F * device.shapenode.Bounds.Width + device.shapenode.Bounds.X,
                1.00F * device.shapenode.Bounds.Height + device.shapenode.Bounds.Y));
        ...
        private void button103_Click(object sender, EventArgs e)
        {
            ...
            countDevice += 1;
            node.Id = "" + countDevice;
            node.Image = Properties.Resources._3_bo_loc_khi;
            node.Transparent = true;
            node.ImageAlign = MindFusion.Drawing.ImageAlign.Fit;


            device.PortCount = 2;
            device.port.Add(new PointF(0.187F * device.shapenode.Bounds.Width + device.shapenode.Bounds.X,
                1.00F * device.shapenode.Bounds.Height + device.shapenode.Bounds.Y));
            device.port.Add(new PointF(0.744F * device.shapenode.Bounds.Width + device.shapenode.Bounds.X,
                1.00F * device.shapenode.Bounds.Height + device.shapenode.Bounds.Y));
        ...
        private void button98_Click(object sender, EventArgs e)
        {
            ...
            countDevice += 1;
            node.Id = "" + countDevice;
            node.Image = Properties.Resources._4_van32_pneu_spr;
            node.Transparent = true;
            node.ImageAlign = MindFusion.Drawing.ImageAlign.Fit;


            device.PortCount = 3;
            device.port.Add(new PointF(1F * device.shapenode.Bounds.Width + device.shapenode.Bounds.X,
                0.088F * device.shapenode.Bounds.Height + device.shapenode.Bounds.Y));
            device.port.Add(new PointF(1F * device.shapenode.Bounds.Width + device.shapenode.Bounds.X,
                0.605F * device.shapenode.Bounds.Height + device.shapenode.Bounds.Y));
            device.port.Add(new PointF(1F * device.shapenode.Bounds.Width + device.shapenode.Bounds.X,
                0.788F * device.shapenode.Bounds.Height + device.shapenode.Bounds.Y));
            AllDevice.Add(device);
        }
        ...
        private void button97_Click(object sender, EventArgs e)
        {
            ...
            countDevice += 1;
            node.Id = "" + countDevice;
            node.Image = Properties.Resources._5_van_32_push;
            node.Transparent = true;
            node.ImageAlign = MindFusion.Drawing.ImageAlign.Fit;
            ...
            device.port.Add(new PointF(0.325F * device.shapenode.Bounds.Width + device.shapenode.Bounds.X,
                0F * device.shapenode.Bounds.Height + device.shapenode.Bounds.Y));
            device.port.Add(new PointF(0.15F * device.shapenode.Bounds.Width + device.shapenode.Bounds.X,
                0F * device.shapenode.Bounds.Height + device.shapenode.Bounds.Y));
        ...
        private void button105_Click(object sender, EventArgs e)
        {
            ...
            countDevice += 1;
            node.Id = "" + countDevice;
            node.Image = Properties.Resources._1_may_nen_khi;
            node.Transparent = true;
            node.ImageAlign = MindFusion.Drawing.ImageAlign.Fit;
            ...
            device.PortCount = 2;
            device.port.Add(new PointF(1F * device.shapenode.Bounds.Width + device.shapenode.Bounds.X,
                0.044F * device.shapenode.Bounds.Height + device.shapenode.Bounds.Y));
            device.port.Add(new PointF(1F * device.shapenode.Bounds.Width + device.shapenode.Bounds.X,
                0.163F * device.shapenode.Bounds.Height + device.shapenode.Bounds.Y));
